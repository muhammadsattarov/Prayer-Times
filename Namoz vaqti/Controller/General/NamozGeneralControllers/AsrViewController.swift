...
class AsrViewController: UIViewController {
  ...
  var timeTitle = ["1.Niyat qilish", "2.Takbiri tahrima", "3.Qiyom ","4.Ruku ","5.Qiyom", "6.Sajda",  "7.Sajda ","8.Jalsa" ,"9.Sajda ","10.Qiyom"," 11.Ikkinchi raka’at", "12.Qa’da","13.Qolgan rakatlar", "14.Salom"]
  ...
  private func setupViews() {
    ...
    navigationItem.title = "Asr namozi"
    let headerView = NamozHeaderView(frame: CGRect(x: 0,
                                                   y: 0,
                                                   width: view.frame.width,
                                                   height: 250))
    tableView.tableHeaderView = headerView
    headerView.descriptionLabel.text = NamazHeader.asr.description
  }
...
extension AsrViewController: UITableViewDelegate, UITableViewDataSource {
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    cell.configure(title: timeTitle[indexPath.row],
                   ...
                   description: NamozTexts.asrText[indexPath.row])
    return cell
  }
